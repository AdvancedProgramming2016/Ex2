...
#include "../include/TaxiCenter.h"

TaxiCenter::TaxiCenter(const Point &taxiCenterLocation) : taxiCenterLocation(taxiCenterLocation) {}
...
const Point &TaxiCenter::getTaxiCenterLocation() {
